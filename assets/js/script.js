...
// Create an event handler for after the user clicks the search input
...
// Create a function that pulls the current cityList, weather and fivedayforecast frrom the Open Weather API
async function displayWeather() {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=25c9d1d27bc81021bdef546488f43fd1";
    var response = await $.ajax({
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=25c9d1d27bc81021bdef546488f43fd1&lat="+getLat+"&lon="+getLong;
...
var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q="+cityname+"&units=imperial&appid=5be3557ebb9cca30f6bc2a24bf635be6";
var response = await $.ajax({
    url: queryURL,
    method: "GET"
  })
